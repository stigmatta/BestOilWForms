namespace BestOilWForms
{
    public partial class Form1 : Form
    {
        ...
        {
            ProductAmount_TextChanged(sender, textBoxPrice1, e, "Хот-дог");
        }

        private void textBoxAmount2_TextChanged(object sender, EventArgs e)
        {
            ProductAmount_TextChanged(sender, textBoxPrice2, e, "Гамбургер");
        }

        private void textBoxAmount3_TextChanged(object sender, EventArgs e)
        {
            ProductAmount_TextChanged(sender, textBoxPrice3, e, "Картопля-фрі");
        }

        private void textBoxAmount4_TextChanged(object sender, EventArgs e)
        {
            ProductAmount_TextChanged(sender, textBoxPrice4, e, "Кока-Кола");
        }
        ...
        private void UpdateCafeEndPrice()
        {
            ...
            totalCafePrice += GetProductTotal(textBoxAmount1, textBoxPrice1, "Хот-дог");
            totalCafePrice += GetProductTotal(textBoxAmount2, textBoxPrice2, "Гамбургер");
            totalCafePrice += GetProductTotal(textBoxAmount3, textBoxPrice3, "Картопля-фрі");
            totalCafePrice += GetProductTotal(textBoxAmount4, textBoxPrice4, "Кока-Кола");
